...
(function (controllers) {
    ...
    var Sayings = (function () {
        ...
        Sayings.prototype.activate = function () {
            ...
            var combinerPromise = this.common.$q.all(dataPromises).then(function () { return _this.combineData(); });
            this.common.activateController([combinerPromise], controllerId, this.title).then(function () { return _this.log.info("Activated Sayings View"); });
        };
        Sayings.prototype.combineData = function () {
            var _this = this;
            // Populate dictionary with sages
            this.sages.forEach(function (sage) { return _this.sageDictionary[sage.id.toString()] = sage; });
            // Set the sage on each saying using the sage dictionary
            this.sayings.forEach(function (saying) { return saying.sage = _this.sageDictionary[saying.sageId.toString()]; });
        ...
        Sayings.prototype.getProverbs = function () {
            var _this = this;
            return this.datacontext.saying.getAll().then(function (data) { return _this.sayings = data; });
        };
        Sayings.prototype.getSages = function () {
            var _this = this;
            return this.datacontext.sage.getAll().then(function (data) { return _this.sages = data; });
        };
