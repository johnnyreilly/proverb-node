...
(function (controllers) {
    ...
    var SayingEdit = (function () {
        ...
        SayingEdit.prototype.activate = function () {
            ...
            var dataPromises = [this.datacontext.sage.getAll().then(function (data) { return _this.sages = data; })];
            var title;
            if (id) {
                dataPromises.push(this.datacontext.saying.getById(id, true).then(function (saying) { return _this.saying = saying; }));
                title = "Saying Edit";
            }
            else {
                title = "Saying Add";
            ...
            this.common.activateController(dataPromises, controllerId, title).then(function () {
                ...
                if (id) {
                    ...
                    _this.saying.sage = _this._.find(_this.sages, function (s) { return s.id === _this.saying.sageId; });
                }
            });
        };
